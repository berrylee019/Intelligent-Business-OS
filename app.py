...
ALL_PROJECTS = [
    ...
    {"name": "SUROP Platform (DoriVac 미팅용)", "https://misatech-surop.streamlit.app/", "category": "Bio"},
    {"name": "Microbiome AI (장항외과 소개)", "https://microbiome-ai-lab.streamlit.app/": "#", "category": "Bio"},
    {"name": "Pet Longevity AI (친구들께 소개)", "https://pet-longevity-ai.streamlit.app/": "#", "category": "Healthcare"},
    {"name": "Pet Longevity AI (영문판,PH홍보중)", "https://pet-longevity.streamlit.app/": "#", "category": "Healthcare"},
    {"name": "Robot Control System (로봇관제)", "https://robot-control.streamlit.app/": "#", "category": "Tech"},
    {"name": "StyleScan: (의류업체 접촉중) ", "https://style-scan-vip1.streamlit.app/": "#", "category": "Fashion"},
    {"name": "StyleScan: (영문판,PH홍보중) ", "https://stylescan-ai.streamlit.app/": "#", "category": "Fashion"},
    {"name": "StyleScan: (내사진,입어볼옷) ", "https://style-scan-vip2.streamlit.app/": "#", "category": "Fashion"},
    {"name": "StyleScan: Fit-Doctor", "https://fit-doctor-pro-v3.streamlit.app/": "#", "category": "Fashion/Healthcare"},
    {"name": "Chef Noir AI (흑백요리사)", "https://bw-chef.streamlit.app/": "#", "category": "Lifestyle/Recipe"},
    {"name": "Chef Noir AI (영문판,PH홍보중)", "https://chef-noir.streamlit.app/": "#", "category": "Lifestyle/Recipe"},
    {"name": "Longevity OS (장수/수명)", "url": "#", "category": "Healthcare"},
    {"name": "Smart Pharmacy Solution (약국용)", "https://smart-pharmacy-solution.streamlit.app/": "#", "category": "Medical"},
    {"name": "Church Admin Solution (교회행정용)", "https://church.streamlit.app/": "#", "category": "Church"},
    {"name": "Space Ops C2 (우주로테크 연락요)", "https://space-ops.streamlit.app/": "#", "category": "Defense/Space"},
    {"name": "gilead (제약 임상데이터 분석)", "https://gilead-clinical-ai.streamlit.app/": "#", "category": "Medical"},
    {"name": "oncolytic-virus (항암바이러스 임상데이터 분석)", "https://oncolytic-virus.streamlit.app/": "#", "category": "Medical"},
    {"name": "her2-analysis (Her2-low 환자군 분석)", "https://oncolytic-virus.streamlit.app/": "#", "category": "Medical/미화"},
    {"name": "travel-ai (여행ai 고모부아는곳?)", "https://oncolytic-virus.streamlit.app/": "#", "category": "Travel"},
    {"name": "bi (영수증분석)", "https://bi-strategist.streamlit.app/": "#", "category": "경영회계"},
    {"name": "bi (에러 해결)", "https://error-doctor.streamlit.app/": "#", "category": "개발자"}
]
